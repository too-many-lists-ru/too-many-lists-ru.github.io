...
Вместо этого, напишем итерактивное освобождение `List`, которое выведет узлы из их боксов.
...
Боксы способны запускать реализацию drop для своего содержимого непосрердственно, так что у них нет такой проблемы.
