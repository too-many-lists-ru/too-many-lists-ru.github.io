...
Но теперь мы не можем так сделать, потому что `&mut` не копируется (если вы скопируете &mut, у вас будет две мутабельные сслыки на одно и то же место в памяти, что запрещено).
