...
> Hamslaw couldn't believe it. Her face shifted from its usual smug demeanor to an iron mask of rage and determination.
...
> And you can copy raw pointers! What if you go `&mut -> *mut -> &mut -> *mut` and then access the first `*mut`?
...
> In fact, part of the big mistake we made was continuing to use Box! Box has a special annotation in it that tells the compiler "hey this is a lot like `&mut`, because it uniquely owns that pointer".
> Which is true!
